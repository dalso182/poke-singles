-- place_order v2: also snapshots set_name + card_number on each order_items
-- row so admin picking views and historical receipts work without joining
-- back to live products. Logic is otherwise identical to v1.

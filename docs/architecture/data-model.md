...
- Every view (`available_products`, `products_search`, `rifas_listing`) and why each has the `security_invoker` setting it has.
...
#### `rifas_listing` — the ONLY definer view
